Vehicule = function (index, game, player) {
    ...
    this.game.physics.arcade.velocityFromRotation(this.tank.rotation, 0, this.tank.body.velocity);
...
Vehicule.prototype.fire = function(target) {
...
Vehicule.prototype.kill = function() {
	this.alive = false;
	this.tank.kill();
	this.turret.kill();
	this.shadow.kill();
